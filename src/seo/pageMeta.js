...
export const PAGE_META = {
  ...
  '/about': {
    ...
    description:
      'Learn about RV Testing Machines — founder-led expertise in RV machine testing, accredited calibration, R&D, and end-to-end support for quality labs and manufacturing.',
    keywords:
  ...
  '/contact': {
    ...
    description:
      'Contact RV Testing Machines for quotes, calibration scheduling, technical support, and product enquiries. Chennai, Tamil Nadu, India.',
    keywords:
